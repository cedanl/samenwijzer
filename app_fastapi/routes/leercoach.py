"""Leercoach — placeholder; wordt gevuld door de paginamigratie."""
...
def leercoach_home(request: Request):
    redirect = eis_rol(request, "student", "docent")
    if redirect:
        return redirect
    return templates.TemplateResponse(
        request, "in_aanbouw.html", {**sessie_context(request), "titel": "Leercoach"}
    )
