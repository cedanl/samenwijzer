25752 Asfaltafwerker 24 maanden BBL HHW_
C2025-2026
...
Je hebt je ingeschreven voor de opleiding asfaltwerker. De opleiding duurt 2 jaar. Het is soms
...
B1-K1 Basis gww-werk uitvoeren?

B1-K1-W1 Richt de verkeersafzetting in en
...
B1-K1-W4 Verricht voorbereidende?

werkzaamheden?

B1-K1-W5 Verhardingen aanbrengen?

B1-K1-W6 Werkterrein in afgesproken staat
...
Als je bij de Infra een opleiding volgt, heb je te maken met het Bindend Studie Advies(BSA).

Om aan het BSA te voldoen heb je een aantal gesprekken met je Loopbaancoach.

De gesprekken zijn hier per periode weergegeven:

Eind periode 1: medio November heeft het docententeam de eerste studentenbespreking. Hierin

wordt een eerste inschatting gemaakt op basis van de volgende uitgangspunten:

1. Je loopt op schema:

je hebt de nulmetingen voor Nederlands en Rekenen gemaakt en er is een plan opgesteld

om deze onderdelen aan te pakken of de examens te maken
...
Eind periode 2: medio  Januari/februari heeft het docententeam de tweede

studentenbespreking. Hierin wordt voor de tweede keer een inschatting gemaakt op basis van

de volgende uitgangspunten:

1. Je loopt op schema:

je hebt 1 module van de vak theorie behaald

je hebt minimaal 1 examen afgerond van Nederlands, van burgerschap en Loopbaan heb je

van beide 1 domein afgerond, en

je studie- en beroepshouding is voldoende

2. Je loopt het risico op vertraging of een voorlopig negatief BSA:

je hebt geen modules behaald en/of

je studie- en beroepshouding is onvoldoende

Gemaakte afspraken evalueren, heeft verbetertermijn ook verbetering gebracht?

Spoor 1:

Gemaakte afspraken herzien, welke zijn nog nodig om voortgang in de opleiding te

behouden.

Spoor 2:

Indien onvoldoende verbetering kan de mentor in overleg met de opleidingsmanager

ervoor kiezen om een negatief BSA af te geven.

Eind periode 3: medio mei wordt tijdens de derde studentbespreking besloten of en zo ja, op

welke wijze je je opleiding kan voltooien:

1. Je loopt op schema: ( normale overgang naar het volgende leerjaar)

je hebt 2 modules van de vak theorie behaald
...
2. Je gaat je opleiding in een aangepast tempo afronden (vertragen): (Doubleren in geval van

grote studieachterstand, Overgang naar het volgende leerjaar met de mogelijkheid tot verlengen

aan het eind van de opleiding (restklas), bespreek dit met de student.)

je hebt 1 modules afgerond en bent de 2  module aan het afronden en/of
...
je hebt minder dan 2 modules afgerond

je hebt geen examen afgerond van Nederlands

je hebt van Burgerschap en/of Loopbaan geen domein afgerond

je studie- en beroepshouding is onvoldoende

Inspanningsplicht na afgeven negatief bindend studieadvies:

Bij een negatief bindend studieadvies is het onderwijs acht weken inspanningsplichtig om

student naar alternatief te begeleiden, waar nodig met ondersteuning van het

expertisecentrum begeleiding.

Na deze 8 weken mag de kwalificatieplichtige student worden uitgeschreven bij de

opleiding

Student kan dan worden overgedragen aan de leerplichtambtenaar of doorstroompunt. (met

warme overdracht formulier!)
...
Studiebelastingsuren Asfaltafwerker BBL2
