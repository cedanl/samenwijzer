25633 Mediavormgever 36 maanden BOL HRN_
C2025-2026
...
Je hebt gekozen voor de opleiding?mediavormgever.?Daarmee word je opgeleid voor een

beroep waarmee je aan de slag kunt als?mediavormgever.?

De mediavormgever werkt in een multidisciplinair projectteam waarin hij goed kan

samenwerken met zijn collega’s. Hij is iemand die zich kan mengen in het gesprek; kritische

vragen kan stellen, idee n in kan brengen en adviezen kan geven. Hij toont initiatief en is

onderzoekend en flexibel.

De mediavormgever is specifiek verantwoordelijk voor de vormgeving van media die

crossmediaal ingezet wordt. Hij is een specialist in een bepaalde mediavormgeefdiscipline maar

kan tevens meepraten en meedenken met aanverwante disciplines. Dit doet hij in een

ontwikkelomgeving die vooral 'agile' is. Hij is medeverantwoordelijk voor een goed

projectverloop.

Dit alles komt samen in verschillende programma’s waar je mee leert werken: InDesign,

Photoshop, Illustrator, Wordpress, Animate en XD. Hierdoor ontwikkel je uiteindelijk een

totaalconcept met als doel een bedrijf, product of dienst zo goed mogelijk aan te prijzen.

De mediavormgever kan tevens een netwerk opbouwen en onderhouden. Hij weet zich ook te

profileren via een eigen en opvallend portfolio. Waar kun je werken? Reclame- of

ontwerpbureaus, uitgeverijen, web ontwikkelaars, vormgevingsteams van grote merken,

multimediabedrijven etc. Je kunt natuurlijk ook als zelfstandig ondernemer gaan werken.
...
bent opgeleid. Je diploma geeft je een goede start op de arbeidsmarkt. Elke organisatie heeft

tegenwoordig media nodig, dus de vooruitzichten op werk zijn goed! Er is steeds meer vraag

naar mediavormgevers die met unieke vaardigheden en creatieve ontwerpen voor een bedrijf
...
een buitenlandse partnerschool van Talland College;
...
Iedere eerstejaarsstudent krijgt tussen de negende en de twaalfde maand van het eerste

leerjaar een bindend studieadvies.

Dit bindend studieadvies heeft drie mogelijke uitkomsten:

Positief studieadvies (de student voldoet aan de overgangsnorm en kan door naar het

tweede leerjaar);

Voorwaardelijke overgang (de student vertraagt onder vastgestelde voorwaarden of de

student doet het eerste leerjaar over);

Negatief studieadvies (de student staakt de opleiding en wordt doorverwezen

naar Expertisecentrum Begeleiding om een nieuwe opleidingskeuze te maken).
...
Voor één ondersteunend vak mag, per periode, minimaal een niet voldaan/onvoldoende

worden gehaald;

Je hebt alle ondersteunende vakken, die met voldaan/niet voldaan of

onvoldoende/voldoende/goed worden beoordeeld, met een voldaan afgesloten;

Je studie- en beroepshouding zijn met een voldoende afgesloten. (Beroepshouding zie

studiewijzer opleiding vormgeving.)

Je bent voorwaardelijk over naar het tweede leerjaar of je doet het eerste leerjaar over

onder de volgende voorwaarden:

 Voorwaardelijk over naar het tweede leerjaar als:

Je in de laatste periode achterstand hebt opgelopen en de norm van een positief

studieadvies nog niet hebt behaald en je schriftelijk afspraken hebt gemaakt over het
...
Je studie- en beroepshouding onvoldoende zijn en je schriftelijke afspraken hebt gemaakt

over verbetering van deze houding;
...
Voorwaarden voor het halen van ‘Projecten’

Je werkt aan een of meerdere projecten tijdens een periode. Dit zijn projecten die 3 tot 9

weken duren. De projecten worden beoordeeld met een cijfer. Dit cijfer wordt gegeven

doormiddel van het beoordelingsformulier passend bij het project.

Herkansingen

Op het moment van de deadline niets ingeleverd. Ontvang je het cijfer een 1. De herkansing

vindt plaats uiterlijk 2 weken na de deadline eerste inlevermoment.

Per leerjaar mogen er maximaal twee projecten herkanst worden. Waarom maar twee

herkansingen? Projecten vormen de essentie van de opleiding. Haal je gedurende het

schooljaar twee projecten niet, dan zegt dit iets over je vaardigheden en kennis. Dit betekent

dat je het juiste niveau nog niet beheerst.

Periode 1 >> maximaal 3 vakken herkansen (inclusief Project)

Periode 2 >> maximaal 3 vakken herkansen (inclusief Project)

Periode 3 >> maximaal 3 vakken herkansen (inclusief Project)

Periode 4 >> geen herkansingen

Voorwaarden voor het halen van ‘Beroepsgerichte vakken’

Tijdens je studie volg je lessen van de beroepsgerichte vakken. Dit zijn vakken die je nodig

hebt om je projecten te kunnen uitvoeren. Voor het behalen van de beroepsgerichte vakken,

moeten de opdrachten binnen het vak op tijd en op de juiste plek worden ingeleverd en

voldoen aan de beoordelingscriteria van de opdracht.

Op het moment van de deadline niets ingeleverd: cijfer 1. Deadline niet behaald of

onvoldoende gehaald betekent e?e?n herkansingsmogelijkheid per vak in de eerstvolgende

P-week.

Beroepsgerichte vakken zijn:

• Adobe programma's (Photoshop, Illustrator en InDesign,

   later in de studie ook Figma, After effects, en Premiere pro)

• Wordpress

• Tech-lab

• Vakkennis/Vaktheorie

• Brainstorm/concept ontwikkeling
...
Deze lessen kunnen direct van toepassing zijn op een project. De behandelde technieken,

theorie en achtergrond, pas je zichtbaar toe binnen het bijbehorende project.
...
vragen die je hebt over de opleiding en het verloop daarvan. Voor de belangrijkste namen en

adressen van jouw opleiding verwijzen we naar ConnectMe. De naam en het e-mailadres van je

mentor worden aan het begin van het schooljaar bekend gemaakt.
...
e-mail: m.ketzer-sijm@talland.nl
