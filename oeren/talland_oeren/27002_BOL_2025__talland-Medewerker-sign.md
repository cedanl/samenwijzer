27002 Medewerker sign 24 maanden BOL
HHW_ C2025-2026
...
Je hebt je ingeschreven voor de opleiding Medewerker Sign. De opleiding duurt 2 jaar. Het is
...
B1-K1 Vervaardigt sign(deel)producten

B1-K1-W1 Bereidt de signwerkzaamheden

(materiaal)technisch voor

B1-K1-W2 Bereidt de signopdracht digitaal voor

B1-K1-W3 Verwerkt de signopdracht met behulp

van de noodzakelijke apparatuur

B1-K1-W4 Werkt sign(deel)producten af en

assembleert

B1-K1-W5 Maakt sign(deel)producten

transportklaar

B1-K1-W6 Voert bestands- en opslagbeheer uit

van de productiebestanden
...
B1-K2 Monteert sign(deel)producten en levert ze

B1-K2-W1 Bereidt de montage van

sign(deel)producten voor

op

B1-K2-W2 Monteert sign(deel)producten

B1-K2-W3 Levert sign(deel)producten op

De opleiding Medewerker Sign kent geen beroepsgerichte profieldelen.
...
Eisen BPV voor diplomering

De BPV is voldaan als je als:
...
Alle opdrachten uit de BPV-map door school met een voldoende zijn beoordeeld

De gehele BPV-periode door school met een voldoende is beoordeeld
...
Bij Burgerschap volg je actief de lessen en lever je een digitale portfolio in. De inhoud van het

portfolio wordt in de lessen toegelicht. Burgerschap zal in 4 modules (dimensies) aangeboden
...
zorg te dragen voor de eigen

Bereidheid en vermogen om te

reflecteren op eigen leefstijl en
...
inleveren opdrachten en

opbouwen digitale portfolio
...
Bij Loopbaan volg je actief de lessen en lever je een digitale portfolio in. De inhoud van het

portfolio wordt in de lessen toegelicht. Loopbaan zal in 5 competenties/modules aangeboden

worden, alle competenties/modules zal de student moeten volgen en daarin zal de student groei

moeten laten zien. De wijze van laten zien worden in de les toegelicht. Denk dan aan activiteiten

in en buiten de klas, gesprekken met docent, en opdrachten uit de methode.
...
Kwailiteitenreflectie

Werkexploratie

Loopbaansturing

HARPA-gesprekken, BPV-

lessen,

Actief deelnemen aan de

gesprekken en loopbaanlessen
...
Na elke periode wordt jouw voortgang besproken door het team van docenten. Verder kun je in

Eduarte zien welke onderdelen je hebt behaald en welke niet. Hieronder lees je wanneer voor

welk vervolg gekozen wordt:

Je loopt op schema en gaat regulier verder met de opleiding wanneer:

Jouw studie- en beroepshouding voldoende is (besproken in periodiek HARPA gesprek) en

je alle gegeven vakken met een voldoende afrond

Je loopt niet op schema en gaat de opleiding in een aangepast tempo afronden wanneer:

Jouw studie- en beroepshouding voldoende is (besproken in periodiek HARPA gesprek) en

je nog niet alle gegeven vakken met een voldoende hebt afgerond maar wel een positief
...
Jouw studie- en beroepshouding onvoldoende is (besproken in periodiek HARPA gesprek)

en

je nog niet alle gegeven vakken met een voldoende hebt afgerond en geen positief advies
