...
36 maanden BBL ALK_ C2025-2026
...
je hebt je ingeschreven voor de opleiding ?Pedagogisch medewerker kinderopvang.? De BBL-

opleiding duurt ?2? jaar en betreft een versnelde route ten opzichte van de (driejarige) BOL

variant. Het is soms mogelijk hier korter of langer over te doen. Dit hangt af van jouw inzet en de
...
B1-K1-W1 Zorgt voor een veilig pedagogisch

klimaat

B1-K1-W2 Inventariseert behoeften en wensen

van het kind

B1-K1-W3 Bereidt de uitvoering van activiteiten

voor

B1-K1-W4 Creëert een verantwoorde en

stimulerende speel-/leeromgeving

B1-K1-W5 Werkt samen met andere betrokkenen

in de omgeving van het kind

B1-K1-W6 Volgt en stimuleert de ontwikkeling en
...
P1-K1 Opvoeden en ontwikkelen van het kind/ de

begeleiding en voert het uit
...
P1-K1-W6 Draagt zorg voor een hygiënische en
...
Je dient minimaal 75% van de studiepunten te behalen voor een positief BSA.

Alle toetsen die voorwaardelijk zijn voor een examen dienen minimaal met een 5,5 afgerond te

zijn.

Als één van de voorwaardelijke toetsen aan het einde van het schooljaar nog onvoldoende is,

mag er per examenonderdeel een tweede herkansing (3e kans) worden gemaakt. Let op dat

met het woord toetsen niet alleen kennistoetsen, maar ook werkstukken, (BPV) opdrachten,

presentaties, projecten enzovoort kan worden bedoeld.
...
Bij onvoldoende studievoortgang (onder de minimumnorm) en na afwegen van persoonlijke

omstandigheden volgt een schriftelijk negatief bindend studieadvies voor deze opleiding.

Je wordt doorverwezen naar het expertisecentrum begeleiding/servicecentrum voor
...
Examenonderdeel B1-K1: Begeleiden van kinderen bij hun
ontwikkeling
...
Om voor kerntaak B1-K1 te slagen, moet je voor elk examen minimaal een voldoende (?6)
...
Het eindoordeel van een kerntaak wordt uitgedrukt in een cijfer welke wordt berekend op basis

van bovenstaande punten:

3 - 4 punten      resultaat kerntaak B1-K1: goed (G) (cijfer 8)

2 punten          resultaat kerntaak B1-K1: voldoende (V) (cijfer 6)

1 of meer examens beoordeeld met 0 punten      resultaat kerntaak B1-K1: onvoldoende

(O) (cijfer 4)

De berekening van het resultaat gaat volgens de richtlijnen die zijn vastgesteld in het geldende

Examenreglement mbo van het Talland College.

Deel A. Examinering Basisdeel
Beroepsspecifiek

Examenonderdeel B1-K2: Werken aan kwaliteit en
deskundigheid
...
Om voor kerntaak B1-K2 te slagen, moet je voor elk examen minimaal een voldoende (?6)
...
2 punten          resultaat kerntaak B1-K2: goed (G) (cijfer 8)

1 punten          resultaat kerntaak B1-K2: voldoende (V) (cijfer 6)

1 of meer examens beoordeeld met 0 punten      resultaat kerntaak B1-K2: onvoldoende
...
Deel B. Examinering Profieldeel
Beroepsspecifiek

Examenonderdeel P1-K1 Opvoeden en ontwikkelen van het
...
Om voor kerntaak P1-K1 te slagen, moet je voor elk examen minimaal een voldoende (?6)
...
3 – 4 punten      resultaat kerntaak P1-K1: goed (G) (cijfer 8)

2 punten          resultaat kerntaak P1-K1: voldoende (V) (cijfer 6)

1 of meer examens beoordeeld met 0 punten      resultaat kerntaak P1-K1: onvoldoende
...
Wettelijke beroepsvereisten P1
Deel B. Wettelijke beroepsvereisten

Examenonderdeel P1 Pedagogisch medewerker
kinderopvang
...
Je voldoet aan de wettelijke beroepsvereisten indien:

het gemiddelde van Luisteren, Spreken en Gesprekken voeren minimaal 5,5 is én voor alle

drie de deelvaardigheden afzonderlijk minimaal een 5,0 is behaald.

Luisteren kan worden aangetoond met een 5 of hoger voor:

het CE 3F Lezen/Luisteren of

een IE 3F Luisteren

de leerdoelen van het werken met 0-jarigen beheerst conform bijlage II van de cao

kinderopvang

Als je hebt voldaan aan de wettelijke beroepsvereisten, zoals in hierboven en in onderwijs zijn

beschreven, wordt een verklaring hiervan opgeslagen in het diplomadossier.

De berekening van het resultaat gaat volgens de richtlijnen die zijn vastgesteld in het geldende

Examenreglement mbo van het Talland College.
Vermelding wettelijke beroepsvereisten op diploma en resultatenlijst.

Indien de student voldoet aan de gestelde eisen wordt op het diploma de volgende tekst

opgenomen:

De kandidaat voldoet aan de wettelijke beroepsvereisten zoals vermeld in de wet IKK, te weten:

Het beheersen van de mondelinge taalvaardigheid Spreken, Gesprekken Voeren en

Luisteren op niveau 3F

Het werken met 0- jarigen;

Branchevereisten (niet van invloed op het
...
De student hoeft niet aan de taaleis VE te voldoen om te kunnen diplomeren. De student

voldoet aan de branchevereisten indien:

Het gemiddelde van Lezen, Luisteren, Spreken en Gesprekken voeren minimaal 5,5 is én

voor alle deelvaardigheden afzonderlijk minimaal een 5,0 is behaald.

De examenonderdelen lezen en luisteren kunnen worden aangetoond met een 5 of hoger

voor:

het CE 3F Lezen/Luisteren of

een IE 3F Luisteren en een IE 3F Lezen

De kennis en vaardigheden beheerst gericht op het vroegtijdig bestrijden van achterstanden

bij jonge kinderen, zoals bedoeld in artikel 4, lid 2 Besluit basisvoorwaarden kwaliteit
...
De kandidaat voldoet aan de voorwaarden om te kunnen werken in de voorschoolse educatie

conform artikel 4, lid 2 van het Besluit basisvoorwaarden kwaliteit voorschoolse educatie.
...
Deel C. Examinering Basisdeel Algemeen Nederlandse taal en Rekenen
...
Het eindcijfer voor Nederlands komt tot stand door het gemiddelde te berekenen van het resultaat van

het centraal examen en het instellingsexamen.

Het eindcijfer Nederlands komt als afgerond eindresultaat op de resultatenlijst bij het diploma.

Het resultaat van het instellingsexamen komt tot stand door het gemiddelde van de resultaten voor de

drie taalvaardigheden schrijven, spreken en gesprekken voeren te berekenen.

De resultaten van het centraal examen en van het instellingsexamen worden weergegeven met één

decimaal.

De berekening van de gemiddelden gaat volgens de richtlijnen die zijn vastgesteld in het geldende

Examenreglement MBO van het Talland College. Verder wordt het resultaat bepaald door de geldende

richtlijnen van de overheid (informatie: https://taalenrekenenmbo.nl/).

Rekenvaardigheid

Examenonderdeel: Rekenen
...
Cijfer voor Nederlands tenminste een 5 mits voor rekenen tenminste een 6 behaald is of andersom.
...
Mbo-certificaat Pedagogisch klimaat in de kinderopvang (C0125)
...
Je hebt recht op het mbo-certificaat ‘Pedagogisch klimaat in

de kinderopvang’ als je bij het voortijdig verlaten van de
...
Mbo-certificaat Professioneel samenwerken en communiceren in de kinderopvang
...
Je hebt recht op het mbo-certificaat ‘Professioneel

samenwerken en communiceren in de kinderopvang’ als je

bij het voortijdig verlaten van de opleiding bovenstaande

twee examens met tenminste een voldoende resultaat (>6)

hebt afgerond. Compensatie is niet mogelijk. Je vindt de

examens terug in Deel A en B van het examenplan.
