25650 Apothekersassistent 36 maanden BOL
ALK_ C2025-2026
...
Je hebt je ingeschreven voor de opleiding ?Apothekersassistent. ? De opleiding duurt ?3 ?jaar.
...
je moet kunnen uitvoeren voor het basis- en profieldeel staan hiero
...
Het college biedt ook onderwijs in een internationale contaxt aan. in jouw opleiding merk je daar

het volgende van: Als je aan bepaalde voorwaarden voldoet, kun je mogelijk in aanmerking

komen voor het volgen van een internationale stage. Via je mentor kun je hier meer informatie
...
Uiterlijk eind periode 3 krijg je een waarschuwing als je 25% of meer onvoldoendes hebt van het

gemiddelde cijfer, per vak (theorie en praktijk) per periode P1 en P2

Definitief bindend studieadvies.

Vanaf periode 3 tot einde schooljaar:

Er volgt een negatief bindend studieadvies als je 25% of meer onvoldoendes hebt

periodetoetsen (niet de deeltoetsen) van periode 1 t/m 4
...
B1-K1 Voert geïndividualiseerde farmaceutische
...
B1-K1-W4 Verwerkt patiëntgerelateerde informatie

en administratie (communicatie)

Kerntaak

Werkprocessen

B1-K2 Verleent niet-receptgestuurde zorg aan de

patiënt

Kerntaak

B1-K2-W1 Adviseert over gezondheid en

preventie (maatschappelijk handelen)
...
B1-K3-W2 Stelt op maat gemaakte
...
B1-K4-W3 Werkt multidisc iplinair samen en stemt

werkzaamheden af (samenwerking)
...
Individuele beoordeling van Loopbaan wat leidt tot een getekende loopbaanverklaring voor het d
...
De inspanningsverplichting loopbaan bestaat uit

een opgebouwd portfolio bestaande uit

loopbaanopdrachten

Burgerschap dimensies – Activiteiten inspanningsverplichting

Individuele beoordeling van Burgerschap wat leidt tot een getekende burgerschapsverklaring vo
...
Per dimensie opdrachten

Je kunt het diploma alleen behalen als je ook de BPV met voldoende gevolg hebt afgerond. Je

zorgt ervoor dat opdrachten en beoordelingsformulieren door jouw begeleider van jouw

stage/leerbedrijf wordt ingevuld en ondertekend. Bij twee onvoldoende beoordelingen op

verschillende stages/leerbedrijven word je uitgeschreven van de opleiding. Een onvoldoende

beoordeling kan nooit als een verrassing komen: voordat jouw stageperiode beeindigd is, heb je

al eerder te horen gekregen dat jouw stage als een onvoldoende wordt beoordeeld. Daarbij

worden leerdoelen opgesteld zodat het voor jou duidelijk is waar je aan moet werken.

1. Elke BPV periode dient met een V of G te worden afgesloten

Bij het niet voldoen hieraan beslist het team welke nadere eisen gesteld worden

2. Alle geplande stagedagen dienen gelopen te worden

3. Een aangeboden BPV plaats kan niet geweigerd worden

4. Bij de beoordeling van de BPV wordt het leerbedrijf betrokken
...
Jouw mentor is het eerste aanspreekpunt voor al je vragen.

Opleidingsmanager

Yvonne Minneboo

y.minneboo@talland.nl
...
E-mail: directiesecretaresses@talland.nl
