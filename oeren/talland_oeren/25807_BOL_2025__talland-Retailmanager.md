25807 Retailmanager 36 maanden BOL HHW_
C2025-2026
...
Bij de locatie heerhugowaard gaat het examenplan wijzigen en bij Zaandam niet, daarom

is het examenplan niet toegevoegd.
...
Je hebt je ingeschreven voor de opleiding ?Retailmanager.? De opleiding duurt ?3 jaar. Het is

soms mogelijk hier korter of langer over te doen. Dit hangt af van jouw inzet en de
...
B1-K1 Werkt mee aan hospitality, advies en
...
B1-K1-W4 Ondersteunt het retailteam tijdens de
...
B1-K2-W2 Begeleidt de artikelpresentatie en/of

visual merchandising

B1-K2-W3 Informeert retailteam over trends,

bedrijfsvoering en visie

B1-K2-W4 Initieert en/of begeleidt

verbeterprocessen binnen de eigen afdeling of

vestiging

B1-K2-W5 Profileert de organisatie in de lokale

markt

B1-K3 Voert taken omtrent

personeelsmanagement uit

B1-K4 Geeft tactisch leiding aan de eigen afdeling

of vestiging

B1-K3-W1 Maakt werkplanningen

B1-K3-W2 Voert activiteiten uit ten behoeve van

in- en uitstroom van medewerkers

B1-K3-W3 Voert activiteiten uit ten behoeve van

beoordelen en ontwikkelen van medewerkers.

B1-K3-W4 Voert activiteiten uit ten behoeve van

het verzuimbeleid

B1-K4-W1 Stelt doelstellingen op voor de eigen

afdeling of vestiging

B1-K4-W2 Interpreteert beschikbare operationele

gegevens voor strategische verbeteringen.
...
merk je daar het volgende van: Je kan bij ons op internationale stage gaan of deelnemen aan

keuzedelen met een internationaal karakter.
...
kostprijsberekeningk4

breakeven

k4

budget en budgetbewaken

k4

liquiditeitsbegrotingk4
...
Overige BSA modules leerjaar 1
...
ICT algemene vaardigheden

ICT office vaardigheden
...
Tijdens jouw opleiding word je op verschillende onderdelen geëxamineerd (zie examenplan).

In bovenstaand overzicht is te zien welke onderwijsmodules voorbereiden op welk examen. Om

deel te kunnen nemen aan een examen heb je een GO nodig van de opleiding. Criteria voor

een GO zijn:

Je dient de voorwaardelijke toetsen van de modules gemiddeld met een voldoende

(minimaal 5,5) af te ronden.

Het is mogelijk om deelresultaten van de voorwaardelijke modules te compenseren.

Je dient iedere voorwaardelijke module minimaal af te ronden met een 4,0.

Het oordeel van het docententeam is te allen tijde bepalend bij het geven van een GO/ NO

GO voor een examenonderdeel.

Herkansen modules

Voor het herkansen van de resultaten van de modules gelden de volgende richtlijnen

Na iedere periode mag 1 module herkanst worden

Een voorwaardelijke module mag maximaal 2 keer herkanst worden

Het docententeam heeft de bevoegdheid om van de richtlijnen af te wijken indien er

omstandigheden zijn waarin dit volgens het docententeam als billijk wordt geacht.
...
bijgehouden in EduArte. Deze is voor de student

De studievoortgang van de student wordt

Gedurende het schooljaar??

en de ouders inzichtelijk.????

De opleiding verzorgt de reguliere kennismakings-

en voortgangsgesprekken.???

Eind periode 1 (november) en/of eind periode 2??

Eind periode 2 en uiterlijk eind periode 3 (april)?

Tussen de 9 en 12 maanden na de start van je

opleiding???

Uiterlijk eind periode 4 (na de laatste toetsen)?

Stap 1: zorgen over jouw voortgang???

Bij onvoldoende studievoortgang uiten wij onze

zorgen naar je door middel van:???

een of meerdere gesprek(ken) met je SLB-

docent; wanneer je onder de 18 bent samen

met je ouders.??

het vastleggen van deze gesprekken

(dossieropbouw)??

de afspraken die we maken, worden

vastgelegd in een tweezijdige afsprakenlijst,

ondertekend door je SLB-docent en jezelf/je

ouders.???

Aandachtspunt is op tijd -vóór 1 april- aanmelden

voor een andere opleiding (als back-up).??

Stap 2: de officiële waarschuwing??

Bij onvoldoende uitzicht op het behalen van

minimumaantal studiepunten (45) krijg je een

Officiële waarschuwing per brief, ondertekend

door de opleidingsmanager.??

De brief wordt toegelicht in een gesprek samen

met je ouders (student onder de 18 jaar).???

NB: Als het Horizon College de gemaakte

afspraken onvoldoende nakomt, ontvangt de

student geen officiële waarschuwing. Er volgt dan

een nieuwe afsprakenlijst.??

Stap 3: uitgeven negatief BSA??

Bij onvoldoende studiepunten (onder de 45

studiepunten) en na afwegen van persoonlijke

omstandigheden volgt een schriftelijk negatief

bindend studieadvies voor deze opleiding,

ondertekend door de opleidingsmanager.???

Overgangsbrief met voorwaarde/brief met uitleg

waarom je moet doubleren.???

Wanneer je tussen de 35 en 45 studiepunten hebt,

word je besproken in het docententeam. Via een

brief word je op de hoogte gebracht van de
...
Wanneer je voldoende studiepunten hebt (ten

minste 45), krijg je van je SLB-docent te horen dat

je door mag naar het tweede jaar. Je krijgt je

resultatenlijst mee en een (korte) brief met een

positief (bindend) studieadvies. Deze brief zal

digitaal verstuurd worden.???
...
10
25807 Lesweken volgens jaarrooster

10

10

leerweg :  BOLAantal lesweken
...
di/woedi/woe do/vrij do/vrijdo / vrijdo / vrij ma/di ma/di ma/di ma/di
...
9,0
winkelconcept en winkelformule
...
9,0
logistieke processen in de retail

1,0

voorraadbeheer in de retail
...
begeleiden, coordineren en coachen

13,5

leidinggeven 13,5

aanstelling&functioneren
...
Totalen in klokuren les

1522,5 21,0 22,5 17,5 17,0 17,5 15,5 14,0 12,5 15,0 13,0
...
0,0 160,0 160,0 160,0 160,0 160,0 160,0 160,0 160,0 160,0 0,0
...
10,0 10,0 10,0 10,0 10,0 10,0 10,0 10,0 20,0 20,0 20,0 20,0
...
wordt gehaald. Tijdens de BPV heeft de school verschillende contactmomenten met het bedrijf

en de student om beide te informeren en de studievoortgang te bewaken. Hierbij is minimaal 1

fysiek contactmoment de norm.

Beoordeling van de BPV

Je kunt het diploma alleen behalen als je ook de BPV met voldoende gevolg hebt afgerond.

Daarvoor moet je aan de volgende regels hebben voldaan:

- Je moet voldaan hebben aan de wettelijke urennorm van BPV, welke zijn vastgelegd via de

praktijkovereenkomst.?

- Je moet alle opdrachten geüpload hebben in de digitale examenomgeving (ESS).
