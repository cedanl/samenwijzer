25960 Helpende Zorg en Welzijn 24 maanden
BOL ALK_HRN_ C2025-2026
...
Je hebt je ingeschreven voor de opleiding niveau 2. De opleiding duurt ?2? jaar. Het is soms
...
B1-K1-W1 Bereid werkzaamheden voor en stemt

af

B1-K1-W2 Treedt op als online en/of offline

aanspreekpunt

B1-K1-W3 Draagt bij aan een fysiek en sociaal
...
P2-K1 Ondersteunt bij dagelijkse activiteiten in
...
P2-K1-W3 Ondersteunt bij persoonlijke zorg en

ADL

P2-K1-W4 Assisteert bij het ondernemen van

activiteiten gericht op dagbesteding en
...
Met een niveau 2 diploma kun je doorstromen naar een niveau 3 of 4 opleiding.
...
beroepspraktijkvorming (BPV/). Daarnaast zijn er ook zelfstudie-uren. Het onderwijs wordt

aangeboden zowel op een hoofdlocatie als in een wijkleercentrum.

Omdat het onderwijs modulair wordt aangeboden, ga je gedurende de opleiding gefaseerd

examens maken. Dat wil zeggen, dat je certificaten kunt meekrijgen wanneer je eerder met de

opleiding stopt, voor de reeds behaalde examens.De volgorde van de modules staan vast.
...
* Voor studenten die de opleiding in 1,5 jaar afronden, dient de eindbeoordeling BPV in P4 te

worden ingeleverd. Voor de studenten die de opleiding in 2 jaar afronden, dient de

eindbeoordeling BPV in P6 te worden ingeleverd.

** Het eindverslag van Wijkleren dient eind P5 te worden ingeleverd.

De toetsvorm per toets wordt duidelijk gemaakt in de studiewijzer van het desbetreffende vak.

De cijfers van de toetsen, vermeld in het toetsplan, worden ingevoerd in Eduarte en zijn voor de

student via de Eduarte app in te zien. Het gehele toetsplan is voorwaardelijk om een GO te

ontvangen voor de examens.

Bij elke toets is er recht op 1 herkansing. Een eventuele tweede herkansing kan worden

aangevraagd bij de opleidingsmanager. Deze wijst de tweede herkansing toe of af. Wanneer de

herkansing onvoldoende score heeft, betekent dit het einde van de opleiding.

Het vak EHBO is een inspanningsverplichting en wordt afgesloten met een bewijs van

deelname van het Talland College.

Verplichte BPV-opdrachten:

Buiten het toetsplan om, dienen er 6 verplichte BPV-opdrachten ingeleverd worden:
...
Deze opdrachten staan beschreven in de BPV-gids.

Je kunt pas een eindbeoordeling BPV aanvragen als alle 6 de opdrachten met een

voldoende zijn afgerond.

Bij onvoldoende resultaat:

Bij een onvoldoende voor een BPV-opdracht moet de opdracht worden herkanst.

Bij een onvoldoende voor de herkansing volgt een onvoldoende BPV-eindbeoordeling.

De stage wordt beëindigd.

Beslissing over tweede stageplaats:

Het docententeam en de opleidingsmanager beslissen of er een tweede stageplaats

aangeboden wordt. Deze beslissing is afhankelijk van je aanwezigheid, houding op zowel

BPV als op school, inzet en resultaten.

Als een tweede kans wordt gegeven, is dit de laatste stage. Onvoldoende voor de tweede

stage betekent het beëindigen van de opleiding. Als je geen tweede kans krijgt, dan

betekent dit tevens dat je opleiding wordt beëindigd.

Uitgangspunten BSA

De normering voor een positief BSA is dat je in ieder geval naar verwachting 75% van de

onderdelen van het eerste leerjaar hebt behaald. Let op dat met het woord onderdelen niet

alleen kennistoetsen, maar ook modules, werkstukken, (BPV) opdrachten, presentaties,

projecten enzovoort kan worden bedoeld. Bij de AVO vakken bestaat dit uit de eerste examens,

tijdens de lessen krijg je toetsen om je niveau te bepalen. Aan de hand hiervan kan worden

bepaald waar je nog aan dient te werken.
...
Urenoverzicht leerjaar 1 en 2 BOL 2
...
Kwalificatiedossiernummer: 23385

Opleidingsnummer: 25960
...
1. Deel C. Examinering Basisdeel generiek
...
Examenonderdeel B1-K1: Voert dienstverlenende werkzaamheden uit
...
Het eindoordeel van een kerntaak wordt uitgedrukt in een cijfer. Het cijfer van een

kerntaak wordt berekend door het gemiddelde te nemen van de onderliggende

cijfers van de examens, waarbij geldt dat het registratiesysteem automatisch de O, V

of G omzet in respectievelijk een 4, 6 of 8. Als het eindresultaat op een kerntaak

gelijk of hoger is dan 7,0; dan wordt het eindresultaat afgerond naar een 8,0. Bij het

bepalen van het eindresultaat wordt bovenstaande weging meegenomen.
...
* Als je de 1-jarige opleiding volgt, doe je dit examen in periode 3 of 4.

Examinering profieldeel beroepsspecifiek

Deel B. Examinering  Profieldeel Beroepsspecifiek

Examenonderdeel  P2-K1:  Ondersteunt bij dagelijkse activiteiten in zorg en welzijn
...
Om voor kerntaak P2-K1 te slagen, moet je voor elk examen minimaal een
...
Deel C. Examinering Basisdeel generiek Nederlandse taal en Rekenen

Examenonderdeel: Nederlandse taal
...
van het resultaat van het centraal examen en het instellingsexamen. Het eindcijfer

Nederlands komt als afgerond eindresultaat op de resultatenlijst bij het diploma.
...
voeren te berekenen. In verband met de cijferdifferentiatie die toegepast wordt

voor mbo-studenten niveau 2 wordt er nadat het samengesteld gewogen cijfer is

berekend, één cijferpunt aan toegevoegd aan het gemiddelde cijfer van het

instellingsexamen. Op het examenresultaat van het centrale examen Nederlands

lezen en luisteren is de cijferdifferentiatie al toegepast.

De resultaten van het centraal examen en van het instellingsexamen worden

weergegeven met één decimaal.

De berekening van de gemiddelden gaat volgens de richtlijnen die zijn vastgesteld

in het geldende Examenreglement mbo van het Talland College. Verder wordt het

resultaat bepaald door de geldende richtlijnen van de overheid (informatie:
...
Als onderdeel van de slaag-zakregeling geldt onderstaande:
...
Deel C. Examinering Basisdeel generiek Loopbaan en Burgerschap
...
Mbo-certificaat  Assisteren bij activiteiten in zorg en welzijn (C0160)
...
Je hebt recht op het mbo-certificaat ‘Assisteren bij activiteiten

in zorg en welzijn’ als je bij het voortijdig verlaten van de

opleiding bovenstaande drie examens met tenminste een

voldoende resultaat (>6) hebt afgerond. Compensatie is niet

mogelijk. Je vindt de examens terug in Deel A en B van het
...
Mbo-certificaat  Individuele basiszorg verlenen (C0163)
...
Je hebt recht op het mbo-certificaat ‘Individuele basiszorg

verlenen’ als je bij het voortijdig verlaten van de opleiding

bovenstaande twee examens met tenminste een voldoende

resultaat (>6) hebt afgerond. Compensatie is niet mogelijk.

Je vindt de examens terug in Deel A en B van het
...
Mbo-certificaat  Ondersteunen bij wonen en voeding (C0164)
...
Je hebt recht op het mbo-certificaat ‘Ondersteunen bij wonen

en voeding ’ als je bij het voortijdig verlaten van de opleiding

bovenstaande twee examens met tenminste een voldoende

resultaat (>6) hebt afgerond. Compensatie is niet mogelijk.

Je vindt de examens terug in Deel B van het examenplan.
...
Mbo-certificaat  Ondersteuning thuis (C0165)
...
Je hebt recht op het mbo-certificaat ‘Ondersteuning thuis’ als

je bij het voortijdig verlaten van de opleiding bovenstaande

twee examens met tenminste een voldoende resultaat (>6)

hebt afgerond. Compensatie is niet mogelijk. Je vindt de

examens terug in Deel B van het examenplan.
...
Mbo-certificaat  Planmatig werken in zorg en welzijn (C0166)
...
Je hebt recht op het mbo-certificaat ‘Planmatig werken in

zorg en welzijn’ als je bij het voortijdig verlaten van de

opleiding bovenstaande twee examens met tenminste een
