25655 Mbo-Verpleegkundige zij-instroom 3-
jarige opleiding 36 maanden BBL ZND_ C2025-
2026
...
Je hebt je ingeschreven voor de opleiding MBO-Verpleegkundige. De opleiding duurt 4 jaar. Het
...
Met het niveau 4-diploma kun je doorstromen naar een hbo-opleiding. Je kunt natuurlijk ook het
...
De mogelijkheid om onderwijs te mogen/kunnen volgen in een internationale context bespreekt

de student met de teammanager zorg en zijn of haar werkgever.
...
Een deel van het theoretisch onderwijs, noodzakelijk om te voldoen aan de urennorm voor de

wet BIG, vindt plaats tijdens de Beroepspraktijkvorming (BPV). Zie hiervoor het document:

verantwoording uren wet BIG. Individuele vrijstellingen en urenverantwoording.docx

In onderstaande tabel is weergegeven hoeveel theoretisch en praktisch onderwijs de opleiding

Op Maat 4 bevat.

Leerjaar

Theoretisch onderwijs gekoppeld aan de wet BIG
...
*studenten hebben gemiddeld 12 uur per week (thuis/praktijk) verwerkingsopdrachten

**studenten maken meer BPV-uren dan de wettelijke kaders voorschrijven omdat zij tijdens de

BPV werken aan o.a. opdrachten voorbereiden examens die gezien worden als begeleide
...
Om voor kerntaak B1-K2 te slagen, moet je voor elk examenonderdeel een

voldoende hebben behaald.

Het eindresultaat van de kerntaak B1-K2 wordt bepaald aan de hand van de

berekening zoals vermeldt in de examenmap van Prove2Move:

·   Het werkproces is met een onvoldoende afgesloten = 0 pnt

 ·  Het werkproces is met een voldoende afgesloten = 1 punt

 ·  Het werkproces is met een goed afgesloten = 2 punten

LET OP !!

De berekening is per werkproces. Voor examenonderdelen die meerdere

werkprocessen bevatten geldt dat de behaalde punten voor elk afzonderlijk

werkproces bij elkaar opgeteld moeten worden.

Voorbeeld: Bestaat een examenonderdeel uit 2 werkprocessen en is dit

examenonderdeel met een GOED afgesloten heb je 4 punten behaald.

Het eindresultaat van de kerntaak B1-K2

5 - 6  punten; resultaat goed

3 - 4 punten; resultaat voldoende

1 of meer werkprocessen met 0; resultaat onvoldoende

De resultaten voor de kerntaken worden omgezet naar een cijfer op basis

van vastgestelde rekenwaarden. O = 4    V = 6    G = 8
...
Dhr.J.W. van der Duin

0683799016

j.vanderduin@talland.nl
...
Carolien Otjens en Erik Bosch a.i.
