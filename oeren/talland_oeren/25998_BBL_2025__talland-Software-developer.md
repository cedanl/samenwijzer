25998 Software developer 24 maanden BBL
ZND_ C2025-2026
...
Je hebt je ingeschreven voor de opleiding ?Software developer.? De opleiding duurt 3 jaar. Het

is soms mogelijk hier korter of langer over te doen. Dit hangt af van jouw inzet en de
...
merk je daar het volgende van:

Internationale stage: je kunt in leerjaar 3, periode 11 en 12 (een deel van) je stage in het

buitenland uitvoeren;

Internationale studiemodule: in leerjaar 2 kun je een studiemodule van 3 weken volgen op

een buitenlandse partnerschool van het Talland College;
...
heeft, dan is het doel om voor jezelf en de docent te bepalen of je de stof beheerst. De

voortgangsbeoordelingen met formele gevolgen worden vastgelegd in een toetsplan. Dat ziet er
...
BurgerschapCijfer Toets Ja

EngelsCijfer Toets Ja
...
Gym Cijfer Opdrachten

Ja

BPV Cijfer PortfolioJa
...
VakleerCijfer Certificaat / Toetsen

Ja

X

KeuzedeelCijfer PortfolioJa
...
Het BSA heeft als doel om tijdig en zorgvuldig formeel vast te stellen dat een student te weinig

studievoortgang heeft geboekt, hij daardoor niet voldoet aan de opleidingseisen voor het 1e jaar

en uitgeschreven mag worden. Studenten volgen daardoor niet te lang een opleiding die niet bij

hen past.

Het BSA wordt bepaald aan de hand van de gewenste ontwikkeling en vooruitgang in het

leerproces van de student, dit noemen we studievoortgang. Formatieve toetsen (w.o.

kennistoetsen, werkstukken, (BPV) opdrachten, presentaties, projecten enzovoort) zijn in

principe het instrument om de studievoortgang te meten. Dus de studievoortgang moet te zien

zijn in onderwijsresultaten die getoetst worden.

Het BSA is uitsluitend gebaseerd op (on)voldoende studievoortgang over de gehele linie. Dit

advies is nadrukkelijk niet bedoeld voor studenten die wegens ziekte of andere persoonlijke

omstandigheden achterstand hebben opgelopen. In deze gevallen geldt dat de student een

persoonlijke leerplan krijgt aangeboden. De student krijgt in dit geval een positief BSA met

schriftelijke afspraken. De school heeft een nazorgplicht van 8 weken vanaf het moment van

afgifte negatief BSA.

De normering voor voldoende studievoortgang is wanneer de student minimaal 75% van de

toetsen van het eerste leerjaar heeft behaald, volgens het toetsplan van het eerste leerjaar.

Elke toets mag maar één keer herkanst worden. Het herkansen van toetsen vindt plaats in de

eerste 5 lesweken van de volgende periode en wordt door de vakdocent georganiseerd.
...
Onderwijs in uren per leerjaar
...
Vakleer (gesplitst in verschillende vakken)
...
Examenonderdeel? B1-K1: Realiseert Software?
...
Examenonderdeel? B1-K2: Voert ICT-projecten uit?
...
Om voor kerntaak B1-K2 te slagen, moet je voor elk werkproces een 5,5 of hoger
...
Afname locatie: bij voorkeur afname tijdens de BPV, indien niet mogelijk dan zal

examinering op school plaatsvinden. Dit alles gaat altijd in overleg met

loopbaancoach en/of BPV-begeleider.

Examinering Basisdeel Algemeen Nederlands en Rekenen

Deel C. Examinering Basisdeel Algemeen Nederlands en
...
Deel C. Examinering Basisdeel Algemeen

Engels

Examenonderdeel: Engels
...
Het eindcijfer voor Engels komt tot stand door het gemiddelde te berekenen

van het resultaat van het Centraal Examen en het Instellingsexamen. Het

eindcijfer Engels komt als afgerond eindresultaat op de resultatenlijst bij het

diploma.

?

Het resultaat van het Instellingsexamen komt tot stand door het gemiddelde

van de resultaten voor de drie taalvaardigheden schrijven, spreken en

gesprekken voeren te berekenen.

De resultaten van het Centraal Examen en van het Instellingsexamen

worden weergegeven met één decimaal.
...
Verder wordt het resultaat bepaald door de geldende richtlijnen van de

overheid (informatie: https://taalenrekenenmbo.nl).

Als onderdeel van de slaag-zakregeling geldt onderstaande:

Cijfer voor Nederlands tenminste een 5 mits voor Engels èn rekenen tenminste een 6 behaald is
