23296 Business Services 36 maanden BOL
ALK_HRN_ C2025-2026
...
Je hebt je ingeschreven voor de opleiding ?Business Services.? Je start met een basisjaar en

vanaf leerjaar 2 stroom je uit naar één van de uitstroomprofielen: Allround Assistant Business

Services (niveau 3), Business & Administration Control Specialist (niveau 4), Legal, Insurance &

HR Services Specialist (niveau 4) of Marketing & Communication Specialist (niveau 4). De

opleiding Allround Asssistant Business Services duurt in totaal ?2 jaar. De andere

uitstroomprofielen duren in totaal 3? jaar. Dit is inclusief het basisjaar. Het is soms mogelijk hier
...
In deze Onderwijs- en examenregeling tref je de bepalingen over het onderwijs en de examens

van leerjaar 1. Vanaf leerjaar 2 dien je de Onderwijs- en examenregeling van het specifieke

uitstroomprofiel dat je hebt gekozen te raadplegen.
...
je moet kunnen uitvoeren in het basisjaar staan hieronder. In dit eerste leerjaar komt het

basisdeel aan bod. Het profieldeel start vanaf leerjaar 2.
...
Voorbeelden van programma’s die zijn gericht op een internationale context zijn Cambridge

Engels en het excellentieprogramma internationalisering. Je studieloopbaanbegeleider kan je

informeren over de mogelijkheden om een excellentieprogramma te volgen.
...
ziet er voor jouw opleiding zo uit: de toetsplannen voor het eerste (brede) leerjaar en de

leerjaren in de uitstroomprofielen worden gepubliceerd in Teams. Je ziet hier per lesperiode de

leerstofplanning en de toetsplanning per vak/onderdeel.

De (formatieve) beoordelingen van vakken vind je terug in het studentportaal van EduArte (via

ConnectMe).

Voor loopbaan & burgerschap bestaat een inspanningsverplichting om je diploma te behalen.
...
In loopbaangesprekken, het

vermogen om te reflecteren op

eigen handelen ten aanzien van

de beroepshouding. Hierin wordt

Een actieve rol tijdens de

specifiek ingegaan op de

(loopbaan)gesprekken en

(ontwikkeling van de) vijf

opvolging van de gemaakte

loopbaancompetenties:

afspraken.

motieven- en kwaliteitenreflectie,
...
Actief deelnemen aan LOB-

lessen en maken en inleveren

van de opdrachten, inclusief de

eindopdracht per thema. ?

gericht op de

loopbaancompetenties:

werkexploratie en netwerken.
...
In de leerstofplanner van jouw opleiding is een toetsplanning opgenomen met daarbij vermeld

het aantal studiepunten wat kan worden behaald. Een toets kan ook zijn het inleveren van een

werkstuk, het geven van een presentatie of het uitvoeren van een project enzovoort. De

leerstofplanner is opgenomen in de digitale leeromgeving in Teams.

Je hebt voldoende studievoortgang als je 75% van de studiepunten, dit is 45 van de 60

studiepunten, hebt behaald. Er kunnen bijzondere omstandigheden zijn die van invloed zijn op

jouw studievoortgang. Het docententeam bepaalt in dat geval op basis van studievoortgang en

persoonlijke omstandigheden of een positief bindend studieadvies wordt afgegeven.
...
In de volgende paragraaf vind je een overzicht van het onderwijsprogramma. In het programma

tref je verschillende soorten leeractiviteiten aan. Hierbij is steeds het aantal studie-uren (SBU’s)

vermeld. Dit is het totale aantal klokuren van 60 minuten dat het jou naar verwachting kost om

de leeractiviteit tot een goed eindresultaat te brengen. Dit is uiteraard ook weer een gemiddelde.

We geven bij de planning ook aan welke uren door ons begeleid worden en welke uren

onbegeleid zijn. De onbegeleide uren kun je op studieplekken in de school besteden, maar

soms ook thuis.

Het programma van leerjaar 1 betreft een basisdeel voor verschillende uitstroomprofielen. Voor

de programmering van deze uitstroomprofielen wordt verwezen naar de betreffende Onderwijs-
...
10
23296 Lesweken volgens jaarrooster
...
Leerjaar 1Project W1: Front Office

36,0

4,0

Project W2: Zakelijke communicatie
...
2,0
Zakelijke communicatie/projectmatig werken

18,0

Project W3: Gegevensverwerking

36,0

4,0

Gegevensverwerking/projectmatig werken
...
54,0 6,0
Project W4: Werken in een organisatie
...
Beroepsoriëntatie-weken (P2/3/4: wk 1)
...
Overige klokuur (Beroepsoriëntatie)
...
De programmering vanaf leerjaar 2 tref je in de Onderwijs- en examenregeling van het

betreffende uitstroomprofiel dat je hebt gekozen.
...
Examenonderdeel Basisdeel 1 Kerntaak 1: Voert taken uit binnen de zakelijke
...
Om voor kerntaak B1-K1 te slagen, moet je voor elk werkproces een 5,5 of hoger
...
Als onderdeel van de profielen 3 t/m 6 (crebo’s 25728, 25725, 25726 en 25727)

worden de examens B1-K1-W1 t/m W4 afgenomen op niveau 4 (EP3).

Examinering profieldeel beroepsspecifiek

Niet van toepassing voor het basisjaar (leerjaar 1).

Zie hiervoor het examenplan van het betreffende uitstroomprofiel (vanaf leerjaar 2 van de

opleiding)

Examinering Basisdeel Algemeen Nederlands en Rekenen

Niet van toepassing voor het basisjaar (leerjaar 1): de examens van Nederlands en Rekenen

worden afgenomen vanaf leerjaar 2. Zie hiervoor het examenplan van het betreffende

uitstroomprofiel (vanaf leerjaar 2 van de opleiding).
...
Deel C. Examinering Algemeen: Loopbaan en Burgerschap
...
Niet van toepassing voor het basisjaar (leerjaar 1): zie voor de BPV het examenplan van het

betreffende uitstroomprofiel (vanaf leerjaar 2 van de opleiding).
...
Jouw opleiding wordt geleid door de opleidingsmanagers:

E. Janssen (Alkmaar) en J. Godschalk (Hoorn)
