25870 Middenkaderfunctionaris bouw 48
maanden BOL HHW_HRN_ZND_ C2025-2026
...
Je hebt je ingeschreven voor de opleiding Middenkaderfunctionaris Bouwkunde. De opleiding

duurt 3 of 4 jaar. Als je een voorkeur hebt voor Smart Building kun je in het 3e of 4e leerjaar

kiezen voor lesonderdelen die specifiek gericht zijn op dit uitstroomprofiel.
...
P1 Middenkaderfunctionaris bouw 4 Nee middenkaderopleiding

B1-K1 Verzamelt, verwerkt en integreert
...
De profielen in dit kwalificatiedossier hebben de volgende (specifieke) kerntaken en

werkprocessen:

P1 Middenkaderfunctionaris bouw

P1-K1 Werkt B&U-ontwerpen uit P1-K1-W1 Werkt ontwerp uit

P1-K1-W2 Maakt ontwerp gereed voor aanvraag

omgevingsvergunning en contractvorming

P1-K2 Voert werkvoorbereiding voor de B&U
...
P1-K3 Begeleidt nieuwbouw en

onderhoudswerk

P1-K3-W1 Begeleidt bouwwerkzaamheden

P1-K3-W2 Bewaakt tijd en kosten van de bouwwerkzaamheden

P1-K3-W3 Controleert de maatvoering

P1-K3-W4 Voert kwaliteitscontroles uit

P2 Middenkaderfunctionaris grond-, weg- en waterbouw

P2-K1 Bereidt infrawerk voor P2-K1-W1 Werkt ontwerp uit
...
P2-K2 Begeleidt uitvoering van infrawerk P2-K2-W1 Begeleidt infrawerkzaamheden
...
P3 Middenkaderfunctionaris landmeetkunde

P3-K1 Zet uit, wint in en verwerkt geoinformatie

P3-K1-W1 Meet situaties in

P3-K1-W2 Voert DTM-metingen uit

5 van 20

P3 Middenkaderfunctionaris landmeetkunde

P3-K1-W3 Meet deformatie

P3-K1-W4 Zet maatvoering uit

P3-K2 Beheert geo-informatie P3-K2-W1 Wint geo-informatie in

P3-K2-W2 Actualiseert en beheert geo-informatie

P4 Middenkaderfunctionaris verkeer en stedenbouw

P4-K1 Voert verkeers- en/of

stedenbouwkundig onderzoek uit

P4-K1-W1 Bereidt historisch, juridisch en omgevingsonderzoek

voor

P4-K1-W2 Voert historisch, juridisch en omgevingsonderzoek uit

P4-K2 Werkt verkeers- en/of

stedenbouwkundig plan uit

P4-K2-W1 Werkt verkeers- en/of stedenbouwkundig ontwerp uit

P4-K2-W2 Verbeeldt verkeers- en/of stedenbouwkundige
...
Het College biedt ook onderwijs in een internationale context aan. In jouw opleiding merk je

daar het volgende van:

De opleiding biedt de mogelijkheid aan studenten (bij gebleken geschiktheid) om in het derde

leerjaar voor een periode van maximaal 10 weken een Internationale stage te volgen. Je mentor

kan je informeren over de mogelijkheden en toelatingseisen.

Daarnaast worden er internationaliseringsprogramma’s aangeboden waar studenten voor

geselecteerd worden. Een voorbeeld hiervan is Cambridge Engels.
...
studieloopbaanbegeleider met je afspreken wat je nog moet doen.
...
De normering voor een positief BSA is dat je in ieder geval 80% van de toetsen van het eerste
...
omstandigheden. Bij een positief BSA mag je de opleiding vervolgen. Bij een negatief BSA moet

je stoppen met de opleiding en begeleiden we je naar een andere passende opleiding. Voordat

een negatief BSA gegeven wordt, krijg je eerst een officiële waarschuwing en dit noemen we

een voorlopig studieadvies (VSA).
...
(klacht@talland.nl). De inschrijving kan pas definitief eindigen nadat de Commissie van Beroep
...
Bij onvoldoende studievoortgang ( 80% behaald) worden de zorgen geuit over jouw

voortgang door één of meerdere gesprek(ken) met jou en eventueel je ouder(s)/voogd(en).

De uitkomst van de gesprek(ken) wordt vastgelegd in een afsprakenlijst.

Uiterlijk begin periode 3

Als je bij de start van periode 3 nog geen 80% behaald hebt, ontvang je een officiële

waarschuwing per brief /e-mail. Deze waarschuwing noemen we een voorlopig studieadvies

(VSA). De brief wordt toegelicht in een gesprek met jou en eventueel je ouder(s)/voogd(en).

Uiterlijk 1 juni

Bij onvoldoende studievoortgang/ studiepunten (80% behaald) en na afwegen van

persoonlijke omstandigheden volgt een schriftelijk negatief bindend studieadvies voor deze

opleiding. Je wordt doorverwezen naar het expertisecentrum begeleiding/ servicecentrum

voor studiekeuzeadvies of intake bij een nieuwe opleiding.

Uiterlijk eind periode 4

Bij voldoende studievoortgang krijg je van de studieloopbaanbegeleider te horen dat je de

opleiding kunt vervolgen. Je krijgt een brief of e-mail met een positief bindend studieadvies.

Normering van Bindend studieadvies:

Bij de beoordeling van het BSA wordt gekeken naar de volgende onderdelen:
...
Je behaalde studieresultaten voldoen aan de eisen van het toetsplan;

Je ongeoorloofde afwezigheid bij lessen en lesgebonden activiteiten is maximaal 5 -10%

van de aangeboden onderwijstijd;

Je bent aanwezig op de georganiseerde onderwijsactiviteiten buiten het reguliere

lesprogramma om, zoals bijvoorbeeld excursies, praktijkbezoek etc.;

Volgens onderstaande niveauomschrijving beroepshouding (zie tabel) zijn minimaal 10 van

de criteria behorende bij de aangegeven soft skills beoordeeld onder de kolommen van

gewenst gedrag.

Voorwaardelijk over of doubleren:

Voorwaardelijk over, dit is mogelijk onder de volgende voorwaarden:

Je voldoet net niet aan de normering voor studieresultaten doordat maximaal 1

vak teveel (buiten de norm van  80%) onvoldoende beoordeeld is. In overleg met je

mentor wordt afgesproken hoe je dit aan het begin van het tweede leerjaar gaat

herstellen;

Aan de overige eisen zoals aangegeven bij een positief BSA voldoe je wel.

Doubleren, dit is mogelijk onder de volgende voorwaarden:

Je voldoet niet aan de normering voor studieresultaten doordat meer dan 1 vak teveel

(buiten de norm van 80%) onvoldoende beoordeeld is.

Aan de overige eisen zoals aangegeven bij een positief BSA voldoe je wel;

Je doet het eerste schooljaar in zijn geheel over, alle onderdelen en alle vakken. Reeds

behaalde resultaten komen te vervallen.
...
Examenonderdeel  Verzamelt, verwerkt en integreert projectinformatie
...
Om voor kerntaak B1-K1 te slagen, moet je voor elk werkproces minimaal een

beoordeling V (voldoende) hebben behaald.
...
Examenonderdeel Werkt B&U-ontwerpen uit
...
Om voor kerntaak P1-K1 te slagen, moet je voor elk werkproces minimaal een
...
Examenonderdeel Voert werkvoorbereiding voor de B&U uit
...
Om voor kerntaak P1-K2 te slagen, moet je voor elk werkproces minimaal een
...
Deel C. Examinering Basisdeel Algemeen Nederlands, Engels en Rekenen
...
Het eindcijfer voor Engels komt tot stand door het gemiddelde te berekenen van

het resultaat van het Centraal Examen en het Instellingsexamen.

Het eindcijfer Engels komt als afgerond eindresultaat op de resultatenlijst bij het
...
Voor niveau 4 geldt dat studenten minimaal een 5, 6 en 6 halen

voor rekenen, Nederlands en Engels in willekeurige volgorde.
...
Examinering Basisdeel Algemeen Engels
...
Cijfer voor Nederlands tenminste een 5, mits voor Engels èn rekenen tenminste een 6 behaald

is of elke andere volgorde.

Examinering Loopbaan en Burgerschap

Inleiding.

In dit boekje zijn 10 LOB- opdrachten en een LOB-evaluatie voor leerjaar 1 gevat. Bij het

ontwikkelen van dit product is rekening gehouden met de vijf loopbaancompetenties, de

onderwijsexamenregeling (OER) en het programma van toetsing en afsluiting (PTA) van de

opleidingen Bouwkunde, Grond-, weg- en waterbouw en Smart Building.

Verder is er voor de docenten de ‘handleiding LOB’ geschreven, waarin het gespreksformat

‘Docent als coach’ staat. Deze biedt handvatten voor het voeren van LOB-gesprekken met

studenten. Evenals een planning voor de LOB-opdrachten voor leerjaar 1 en 2.

In hoofdstuk 1 van dit document staat een korte inleiding voor studenten, zodat je weet wat je te

wachten staat en waarom loopbaanoriëntatie en begeleiding (LOB) wordt gegeven op het

Talland College. Daarna volgen de opdrachten, die in de huisstijl en kleuren van het Talland

College zijn vormgegeven. Per opdracht is beschreven aan welke competenties de student

heeft gewerkt door de opdracht te voltooien.

De student maakt een portfolio als bewijslast voor de inspanningsverplichting en als tool om te

gebruiken bij de LOB-gesprekken.
...
Voortijdig studieadvies (VSA).

Voorbereiding LOB-gesprek.

Reflectie op LOB-gesprek.

Snuffelstage (oriënterende stage).

Excursie!

Keuze BPV leerjaar 2!

Bindend studieadvies (BSA).

Terugblik LOB leerjaar 1.

Voldaan of niet voldaan leerjaar 1:
...
Voor de BPV geldt het volgende:

Je hebt op alle verplichte onderdelen uit het projectplan BPV gemiddeld een voldoende (5,5

of hoger) gehaald; Op basis van de bijbehorende beoordelingsformulieren.

Je hebt een voldoende (5,5 of hoger) voor je bedrijfsbeoordeling; Op basis van de bijbehorende
