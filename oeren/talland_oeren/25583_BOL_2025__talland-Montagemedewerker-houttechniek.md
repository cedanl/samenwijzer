25583 Montagemedewerker houttechniek 24
...
Opleidingsduur
 ...
 Opleidingsduur en leerweg

Je hebt je ingeschreven voor de opleiding Montagemedewerker houttechniek. De opleiding
...
aanmerking voor studiefinanciering vanaf het moment dat je 18 jaar wordt.  Deze leerweg kan

alleen gekozen worden in samenwerking met ESPEQ opleidingsbedrijven of
...
Zagen en schaven van hout en plaatmateriaal met

Werkprocessen

B1-K1-W1 Bereidt zaag- en

schaafwerkzaamheden voor

stationaire houtbewerkingsmachines

B1-K1-W2 Selecteert, controleert en transporteert

hout en plaatmateriaal

B1- K1-W3 Brengt snijgereedschappen van zaag-

en schaafmachines aan en stelt ze in

B1-K1-W4 Stelt zaag- en schaafmachines in

B1-W5 Voert proefbewerkingen met zaag- en

schaafmachines uit

B1-K1-W6 Voert bewerkingen met zaag- en
...
B1-K2: Samenstellen van houten elementen
 ...
 B1-K2-W1 Bereidt samenstellen van houten

elementen voor

B1-K2-W2 Selecteert, controleert en transporteert
...
P1-K1 Afmonteren houten elementen en

P1-K1-W1 Bereidt afmonteren houten elementen

verzendklaar maken

voor

P1-K1-W2 Selecteert, controleert en transporteert
...
Je kunt in het mbo doorstromen naar een hoger niveau. Met het niveau 3 diploma kun je

bijvoorbeeld doorstromen naar de opleiding Technisch Leidinggevende maar je kunt natuurlijk

ook het beroep uitoefenen waarvoor je bent opgeleid. Je diploma geeft je een goede start op de
...
Het Talland College biedt ook onderwijs in een internationale context aan. Je

studieloopbaanbegeleider kan je informeren over de mogelijkheden en de voorwaarden.
...
De opleiding Montagemedewerker Houttechniek kent twee specialisaties: Kozijnen, Ramen en

Deuren (KRD) en Houtskeletbouw (HSB). Hieronder worden beide lesprogramma's toegelicht,

bestaande uit een algemeen deel en een vakspecifiek deel per uitstroom.
...
je hebt 2 modules afgerond en bent de 3  module aan het afronden en/of
...
Studiebelastingsuren  Montagemedewerker BOL2
...
Examenonderdeel   B1-K1 Zagen en schaven van hout en plaatmateriaal met
...
Om voor kerntaak B1-K1 te slagen, moet je voldoen aan de onderstaande beslisregel:

De PvB en VVT hebben elk een weging van 50%. Bij beide toetsen moeten de kerntaken

ten minste met

een voldoende worden afgesloten voor het diploma.

In onderstaand tabel wordt de omzetting van eindoordeel naar eindcijfer weergegeven.
...
Examenonderdeel   B1-K2 Samenstellen van houten elementen
...
Om voor kerntaak B1-K2 te slagen, moet je voldoen aan de onderstaande beslisregel:
...
Examenonderdeel    P1-K1 Afmonteren houten elementen en verzendklaar maken
...
Om voor kerntaak P1-K1 te slagen, moet je voldoen aan de onderstaande beslisregel:
