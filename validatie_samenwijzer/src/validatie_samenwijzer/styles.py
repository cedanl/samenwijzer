...
# `schoon_opleiding_naam` is verplaatst naar de UI-loze module `opleiding` zodat
# backend-modules (chat, ingest, scripts) 'm kunnen hergebruiken zonder streamlit.
# Hierboven geïmporteerd; hier beschikbaar voor bestaande `from ...styles import`-callers.
